    ...
    <section className="bg-white border-y border-gray-100 py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative aspect-[4/3] overflow-hidden border border-gold/20 order-2 lg:order-1">
            <SiteImage
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="font-body text-text-muted text-base leading-relaxed mt-6 max-w-xl">
              If you earn well above the 401(k) limits, a Cash Balance Plan may let you deduct far more
              each year while building retirement wealth on a tax-deferred basis. Montreux designs plans
              in coordination with your investments, tax strategy, and long-term goals.
            </p>
            ...
            <ul className="mt-8 space-y-4">
              {highlights.map((item) => (
                <li key={item.stat} className="flex gap-4 items-start">
                  ...
                  <span className="font-body text-sm text-text-muted leading-relaxed pt-0.5">
                    {item.label}
                  </span>
                </li>
              ))}
